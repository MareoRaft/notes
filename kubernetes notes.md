...
kubectl - CLI for kubernetes CRUD operations. Covers everything you can do.
k9s - interactive CLI, a control panel for kubernetes. Convenient. Does a subset of what kubectl does.
helm - a package manager for kubernetes "charts", that is, yaml config files
...
Chronograf / influx db



## k9s notes
k9s
esc - exit screen - use this to back out of breadcrumbs
? - help - list all commands
shift-a - sort by age
s - get shell into a pod/container
: - enter command - like vim
commands:
- pods
- events
- secrets
- ctx - switch context
- deployments
- helm - to see dem helm charts yo
notes:
* the 'YAML' that you see in k9s is the yaml that was used to create the resource (and it was possibly generated by a helm chart).
